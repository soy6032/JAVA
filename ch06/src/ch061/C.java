...
//		A클래스는 default 접근 제한자를 사용하여 다른 패키지를 사용하는 C클래스에서는 접근이 불가능함.
//		A a = new A();
//		B클래스는 public 접근 제한자를 사용하여 다른 어떠한 클래스에서도 접근이 가능함
//		B b = new B();
		
		
		ABC abc = new ABC();
//		privateName은 ABC 클래스의 멤버변수로 접근 제한자를 private를 
//		사용하기 떄문에 해당 객체 내에서만 사용가능
